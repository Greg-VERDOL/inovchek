...
const SetupUser = ({ classes, ...props }) => {
  ...
  const roleToken = decoded.user.role;
  ...
  useEffect(() => {
    ...
    setUser({ ...user, role: decoded.user.role });
  ...
  const [user, setUser] = useState({
    ...
    password: '',
    role: '',
    roleValue: { store: '', region: '', country: '' }
  });

  const { name, password, roleValue } = user;
  ...
  const onSubmit = e => {
    ...
    if (
      name === '' ||
      password === '' ||
      (UserRoleValue[roleToken] === roleValue[UserRoleValue]) === ''
    ) {
            ...
            <React.Fragment>
              ...
              {user.role === 'manager' ? (
                <FormControl className={classes.formControl}>
                  <InputLabel required htmlFor="store">
                    Select a Store
                  </InputLabel>
                  <Select
                    value={roleValue}
                    ...
                    type="text"
                  >
                    <MenuItem value={'5d1b4cd94720fb10a8041639'}>
                      store1
                    </MenuItem>
                    <MenuItem value={'store2'}>store2</MenuItem>
                    <MenuItem value={'store3'}>store3</MenuItem>
                    <MenuItem value={'store4'}>store4</MenuItem>
                  </Select>
